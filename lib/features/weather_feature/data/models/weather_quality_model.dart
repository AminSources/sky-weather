...
class WeatherQualityModel extends WeatherQualityEntity {
  const WeatherQualityModel({super.data});
...
class Data {
  ...
  Data({this.aqi, this.idx, this.dominentpol, this.time});
  ...
  Data.fromJson(Map<String, dynamic> json)
    : aqi = json['aqi'] as int?,
      ...
      time =
          (json['time'] as Map<String, dynamic>?) != null
